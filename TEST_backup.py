...
def ACL():
    ...
    if typeuser.get() == "User" or typeuser.get()  == "Client":
        print ("TEST Success - User")
        Users = typeuser.get() == "User" or typeuser.get() == "Client"
        print ("Users " + Users)
    elif typeuser.get() == "Junior" or typeuser.get() == "Junior Admin":
        print ("TEST success - junior")
        Junior = typeuser.get() == "Junior" or typeuser.get() == "Junior Admin"
        print ("Junior " + Junior)
    elif typeuser.get() == "Global" or typeuser.get() == "Global Admin":
        print ("test success - global")
        Global = typeuser.get() == "Global" or typeuser.get() == "Global Admin"
        print ("Global " + Global)
    else:
        print ("fail")
